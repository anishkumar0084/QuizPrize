...
import com.quiz.prize.activity.LevelActivity;
import com.quiz.prize.activity.SubcategoryActivity;
import com.quiz.prize.helper.ApiConfig;
import com.quiz.prize.helper.Session;
import com.quiz.prize.helper.Utils;
import com.quiz.prize.model.LuckyItem;
                ...
                try {
                    ...
                    if (error.equalsIgnoreCase("false")) {
                        ...
                        if(data.size()>=2){
                          ...
                          //  Toast.makeText(SpinActivity.this, "Not Enough Category", Toast.LENGTH_SHORT).show();
                        }
